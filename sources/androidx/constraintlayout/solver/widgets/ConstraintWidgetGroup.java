            ...
            if (!widget.isFullyResolved()) {
                ...
                for (ConstraintAnchor constraintAnchor : widget.mListAnchors) {
                    ...
                    if (targetAnchor != null) {
                        ...
                        if (targetWidget != widget.getParent()) {
        ...
        if (widget.mOptimizerMeasurable && !widget.isFullyResolved()) {
            ...
            if (targetAnchor != null) {
                ...
                if (targetAnchor.mType == Type.RIGHT) {
                    end3 = targetAnchor.mOwner.f14mX + targetAnchor.mOwner.getWidth();
                } else if (targetAnchor.mType == Type.LEFT) {
                    end3 = targetAnchor.mOwner.f14mX;
                }
            }
            if (rightSide) {
            ...
            if (widget.mBaseline.mTarget != null) {
                ...
                int start = (targetAnchor3.mOwner.f15mY + targetAnchor3.mOwner.mBaselineDistance) - widget.mBaselineDistance;
            ...
            if (targetAnchor2 != null) {
                ...
                if (targetAnchor2.mType == Type.BOTTOM) {
                    end = targetAnchor2.mOwner.f15mY + targetAnchor2.mOwner.getHeight();
                } else if (targetAnchor2.mType == Type.TOP) {
                    end = targetAnchor2.mOwner.f15mY;
                }
            }
            if (bottomSide) {
