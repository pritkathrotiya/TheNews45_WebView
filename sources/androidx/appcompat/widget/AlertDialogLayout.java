    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0002R.C0004id.topPanel) {
                    topPanel = child;
                } else if (id == C0002R.C0004id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0002R.C0004id.contentPanel && id != C0002R.C0004id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (middlePanel != null && remainingHeight > 0) {
            ...
            int remainingHeight4 = MeasureSpec.makeMeasureSpec(middleHeight + heightToGive2, heightMode);
            middlePanel.measure(i, remainingHeight4);
            usedHeight = usedHeight3 + middlePanel.getMeasuredHeight();
            int i4 = remainingHeight4;
            childState = View.combineMeasuredStates(childState, middlePanel.getMeasuredState());
