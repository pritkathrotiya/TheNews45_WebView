...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0002R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0002R.C0004id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0002R.C0004id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0002R.C0004id.action_bar));
        }
    }
