...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(Context context, int resId) {
        ...
        if (resId == C0002R.C0003drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0002R.C0003drawable.abc_cab_background_internal_bg), getDrawable(context, C0002R.C0003drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(Context context, int resId, boolean failIfNotKnown, Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable2;
        } else if (resId == C0002R.C0003drawable.abc_seekbar_track_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0002R.C0003drawable.abc_ratingbar_material || resId == C0002R.C0003drawable.abc_ratingbar_indicator_material || resId == C0002R.C0003drawable.abc_ratingbar_small_material) {
            LayerDrawable ld2 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0002R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(android.content.Context r13, int r14) {
        /*
            r12 = this;
            androidx.collection.ArrayMap<java.lang.String, androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate> r0 = r12.mDelegates
            r1 = 0
            ...
            androidx.collection.ArrayMap<java.lang.String, androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate> r3 = r12.mDelegates
        ...
        L_0x0076:
            ...
            androidx.collection.ArrayMap<java.lang.String, androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate> r9 = r12.mDelegates     // Catch:{ Exception -> 0x00a8 }
            java.lang.Object r9 = r9.get(r3)     // Catch:{ Exception -> 0x00a8 }
            androidx.appcompat.widget.AppCompatDrawableManager$InflateDelegate r9 = (androidx.appcompat.widget.AppCompatDrawableManager.InflateDelegate) r9     // Catch:{ Exception -> 0x00a8 }
    ...
    static boolean tintDrawableUsingColorFilter(Context context, int resId, Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0002R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0002R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = Mode.MULTIPLY;
        } else if (resId == C0002R.C0003drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
            alpha = Math.round(40.8f);
        } else if (resId == C0002R.C0003drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    static Mode getTintMode(int resId) {
        if (resId == C0002R.C0003drawable.abc_switch_thumb_material) {
    ...
    public synchronized ColorStateList getTintList(Context context, int resId) {
        ...
        if (tint == null) {
            if (resId == C0002R.C0003drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_edittext);
            } else if (resId == C0002R.C0003drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_switch_track);
            } else if (resId == C0002R.C0003drawable.abc_switch_thumb_material) {
                tint = createSwitchThumbColorStateList(context);
            } else if (resId == C0002R.C0003drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0002R.C0003drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0002R.C0003drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else {
                if (resId != C0002R.C0003drawable.abc_spinner_mtrl_am_alpha) {
                    if (resId != C0002R.C0003drawable.abc_spinner_textfield_background_material) {
                        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                            tint = ThemeUtils.getThemeAttrColorStateList(context, C0002R.attr.colorControlNormal);
                        } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_default);
                        } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_btn_checkable);
                        } else if (resId == C0002R.C0003drawable.abc_seekbar_thumb_material) {
                            tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_seek_thumb);
                        }
                    }
                }
                tint = AppCompatResources.getColorStateList(context, C0002R.color.abc_tint_spinner);
            }
            if (tint != null) {
    ...
    private ColorStateList createButtonColorStateList(Context context, int baseColor) {
        ...
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0002R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        ColorStateList thumbColor = ThemeUtils.getThemeAttrColorStateList(context, C0002R.attr.colorSwitchThumbNormal);
        if (thumbColor == null || !thumbColor.isStateful()) {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            colors[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0002R.attr.colorSwitchThumbNormal);
            int i = 0 + 1;
            states[i] = ThemeUtils.CHECKED_STATE_SET;
            colors[i] = ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlActivated);
            int i2 = i + 1;
            states[i2] = ThemeUtils.EMPTY_STATE_SET;
            colors[i2] = ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorSwitchThumbNormal);
            int i3 = i2 + 1;
        } else {
            states[0] = ThemeUtils.DISABLED_STATE_SET;
            ...
            colors[i4] = ThemeUtils.getThemeAttrColor(context, C0002R.attr.colorControlActivated);
            int i5 = i4 + 1;
    ...
    private void checkVectorDrawableSetup(Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0002R.C0003drawable.abc_vector_test);
