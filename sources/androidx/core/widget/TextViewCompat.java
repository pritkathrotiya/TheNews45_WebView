        ...
        private void recomputeProcessTextMenuItems(Menu menu) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < supportedActivities.size(); i2++) {
                    ...
                    menu.add(0, 0, i2 + MENU_ITEM_ORDER_PROCESS_TEXT_INTENT_ACTIONS_START, info.loadLabel(packageManager)).setIntent(createProcessTextIntentForResolveInfo(info, this.mTextView)).setShowAsAction(1);
                }
