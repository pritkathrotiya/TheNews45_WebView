...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0110R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0110R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0110R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0110R.C0112id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null) {
                ...
                if (numActions > 0) {
                    ...
                    for (int i = 0; i < numActions; i++) {
                        remoteViews.addView(C0110R.C0112id.actions, generateActionButton((Action) this.mBuilder.mActions.get(i)));
                    }
                }
            }
            if (!actionsVisible) {
            ...
            remoteViews.setViewVisibility(C0110R.C0112id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0110R.C0112id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0110R.layout.notification_action_tombstone : C0110R.layout.notification_action);
            button.setImageViewBitmap(C0110R.C0112id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0110R.color.notification_action_color_filter)));
            button.setTextViewText(C0110R.C0112id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0110R.C0112id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0110R.C0112id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) {
            ...
            L_0x0028:
                ...
                int r9 = androidx.core.C0110R.C0112id.notification_background
                int r10 = androidx.core.C0110R.C0111drawable.notification_bg_low
                r2.setInt(r9, r6, r10)
                int r9 = androidx.core.C0110R.C0112id.icon
                int r10 = androidx.core.C0110R.C0111drawable.notification_template_icon_low_bg
                r2.setInt(r9, r6, r10)
                goto L_0x0056
            L_0x0048:
                int r9 = androidx.core.C0110R.C0112id.notification_background
                int r10 = androidx.core.C0110R.C0111drawable.notification_bg
                r2.setInt(r9, r6, r10)
                int r9 = androidx.core.C0110R.C0112id.icon
                int r10 = androidx.core.C0110R.C0111drawable.notification_template_icon_bg
                r2.setInt(r9, r6, r10)
            L_0x0056:
                androidx.core.app.NotificationCompat$Builder r6 = r0.mBuilder
                ...
                int r6 = androidx.core.C0110R.C0112id.icon
            ...
            L_0x0076:
                ...
                int r6 = androidx.core.C0110R.dimen.notification_right_icon_size
                int r6 = r1.getDimensionPixelSize(r6)
                int r9 = androidx.core.C0110R.dimen.notification_small_icon_background_padding
                ...
                int r10 = androidx.core.C0110R.C0112id.right_icon
            ...
            L_0x00aa:
                ...
                r2.setImageViewBitmap(r10, r7)
            L_0x00b9:
                int r7 = androidx.core.C0110R.C0112id.right_icon
            ...
            L_0x00bf:
                ...
                int r6 = androidx.core.C0110R.dimen.notification_large_icon_width
                int r6 = r1.getDimensionPixelSize(r6)
                int r7 = androidx.core.C0110R.dimen.notification_big_circle_margin
                int r7 = r1.getDimensionPixelSize(r7)
                int r6 = r6 - r7
                int r7 = androidx.core.C0110R.dimen.notification_small_icon_size_as_large
                int r7 = r1.getDimensionPixelSize(r7)
                androidx.core.app.NotificationCompat$Builder r9 = r0.mBuilder
                ...
                int r10 = androidx.core.C0110R.C0112id.icon
            ...
            L_0x010a:
                ...
                int r6 = androidx.core.C0110R.C0112id.title
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x0119:
                ...
                int r6 = androidx.core.C0110R.C0112id.text
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x0136:
                ...
                int r7 = androidx.core.C0110R.C0112id.info
            ...
            L_0x014e:
                ...
                int r7 = androidx.core.C0110R.integer.status_bar_notification_info_maxnum
                int r7 = r1.getInteger(r7)
                androidx.core.app.NotificationCompat$Builder r8 = r0.mBuilder
                int r8 = r8.mNumber
                if (r8 <= r7) goto L_0x016c
                int r8 = androidx.core.C0110R.C0112id.info
                int r9 = androidx.core.C0110R.string.status_bar_notification_info_overflow
                java.lang.String r9 = r1.getString(r9)
                r2.setTextViewText(r8, r9)
                goto L_0x017e
            L_0x016c:
                java.text.NumberFormat r8 = java.text.NumberFormat.getIntegerInstance()
                int r9 = androidx.core.C0110R.C0112id.info
                androidx.core.app.NotificationCompat$Builder r10 = r0.mBuilder
                int r10 = r10.mNumber
                long r10 = (long) r10
            ...
            L_0x018d:
                ...
                int r6 = androidx.core.C0110R.C0112id.text2
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
                java.lang.CharSequence r7 = r7.mContentText
                r2.setTextViewText(r6, r7)
                int r6 = androidx.core.C0110R.C0112id.text2
            ...
            L_0x01bf:
                ...
                int r5 = androidx.core.C0110R.dimen.notification_subtext_size
                int r5 = r1.getDimensionPixelSize(r5)
                float r5 = (float) r5
                int r6 = androidx.core.C0110R.C0112id.text
                r2.setTextViewTextSize(r6, r12, r5)
            L_0x01d3:
                int r6 = androidx.core.C0110R.C0112id.line1
                r7 = 0
                r8 = 0
                r9 = 0
                r10 = 0
            ...
            L_0x01dd:
                ...
                int r5 = androidx.core.C0110R.C0112id.chronometer
                ...
                goto L_0x022b
            L_0x0219:
                int r5 = androidx.core.C0110R.C0112id.time
                r2.setViewVisibility(r5, r12)
                int r5 = androidx.core.C0110R.C0112id.time
                androidx.core.app.NotificationCompat$Builder r6 = r0.mBuilder
                long r6 = r6.getWhenIfShowing()
            ...
            L_0x022b:
                r11 = 1
            L_0x022c:
                int r5 = androidx.core.C0110R.C0112id.right_side
            ...
            L_0x0234:
                ...
                int r5 = androidx.core.C0110R.C0112id.line3
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0110R.C0111drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0110R.C0112id.notification_main_column);
            outerView.addView(C0110R.C0112id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0110R.C0112id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0110R.C0112id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0110R.C0112id.title, 8);
            outerView.setViewVisibility(C0110R.C0112id.text2, 8);
            outerView.setViewVisibility(C0110R.C0112id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            float largeFactor = (constrain(resources.getConfiguration().fontScale, 1.0f, 1.3f) - 1.0f) / 0.29999995f;
            return Math.round(((1.0f - largeFactor) * ((float) resources.getDimensionPixelSize(C0110R.dimen.notification_top_pad))) + (((float) resources.getDimensionPixelSize(C0110R.dimen.notification_top_pad_large_text)) * largeFactor));
        }
